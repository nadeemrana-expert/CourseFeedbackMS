...
{
    public abstract class CourseFeedbackMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CourseFeedbackMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CourseFeedbackMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CourseFeedbackMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CourseFeedbackMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CourseFeedbackMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CourseFeedbackMSDbContext, Task<T>> func)
        {
            T result;
