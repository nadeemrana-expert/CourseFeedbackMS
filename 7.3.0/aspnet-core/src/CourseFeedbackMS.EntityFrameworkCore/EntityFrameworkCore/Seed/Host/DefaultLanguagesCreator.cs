...
namespace CourseFeedbackMS.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CourseFeedbackMSConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CourseFeedbackMSDbContext context)
        {
            _context = context;
        }
